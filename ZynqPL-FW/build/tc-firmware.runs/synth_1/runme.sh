...
HD_PWD='/home1/shivang/github/TC-readout/ZynqPL-FW/build/tc-firmware.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TC_ZYNQ_BD_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TC_ZYNQ_BD_wrapper.tcl
