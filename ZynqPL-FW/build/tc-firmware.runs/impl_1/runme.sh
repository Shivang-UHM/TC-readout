...
HD_PWD='/home1/shivang/github/TC-readout/ZynqPL-FW/build/tc-firmware.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TC_ZYNQ_BD_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TC_ZYNQ_BD_wrapper.tcl -notrace
